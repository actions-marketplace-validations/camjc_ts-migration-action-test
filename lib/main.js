...
function getAllFilenames(dirPath, fileArr) {
    return __awaiter(this, void 0, void 0, function () {
        var files, _i, files_1, file, filePath, stats;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, getAllFilenames(filePath, fileArr)];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 6];
                case 5:
                ...
                case 6:
                    _i++;
                    return [3 /*break*/, 2];
                case 7: return [2 /*return*/, fileArr];
            }
        });
    });
}
function countByExtension(filenames) {
    return filenames.reduce(function (counts, filename) {
        var _a;
        var extension = filename.split('.').pop() || '';
        return __assign(__assign({}, counts), (_a = {}, _a[extension] = (counts[extension] || 0) + 1, _a));
    }, {});
}
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var myInput, arrayOfFiles;
        return __generator(this, function (_a) {
            try {
                myInput = core_1.default.getInput('myInput');
                core_1.default.debug("Hello " + myInput + " from github runner");
                arrayOfFiles = [];
